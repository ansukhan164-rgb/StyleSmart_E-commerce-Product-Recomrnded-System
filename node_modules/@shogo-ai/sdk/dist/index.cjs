...
__export(index_exports, {
  ...
  CloudFileTransport: () => CloudFileTransport,
  DEFAULT_SHOGO_CLOUD_URL: () => DEFAULT_SHOGO_CLOUD_URL,
  ...
  ShogoAuth: () => ShogoAuth,
  ShogoError: () => ShogoError,
  WebStorageAdapter: () => WebStorageAdapter,
  buildDataUrlFromBase64: () => buildDataUrlFromBase64,
  createClient: () => createClient,
  createShogoLlmProvider: () => createShogoLlmProvider,
  getDefaultClient: () => getDefaultClient,
  getDefaultStorageAdapter: () => getDefaultStorageAdapter,
  isBrowser: () => isBrowser,
  useCollection: () => useCollection,
  useDomain: () => useDomain,
  useDomainReady: () => useDomainReady,
...
// src/client.ts
var import_voice = require("@shogo-ai/voice");
var ShogoClientImpl = class {
  ...
  buildTelephony(shogoApiKey) {
    ...
    if ((0, import_voice.isVoiceMockEnv)()) {
      return new import_voice.MockTelephonyClient({ projectId: projectId ?? void 0 });
    }
    const runtimeToken = typeof process !== "undefined" ? process.env?.RUNTIME_AUTH_SECRET : void 0;
    ...
    if (hasRuntime) {
      return new import_voice.HostedRuntimeTokenClient({
        runtimeToken,
        projectId,
        apiUrl
      });
    ...
    if (hasHosted) {
      return new import_voice.HostedTelephonyClient({
        shogoApiKey,
        projectId,
        apiUrl
      });
    ...
    if (hasDirect) {
      return new import_voice.DirectTelephonyClient({
        projectId,
        elevenlabs,
        twilio
      });
...
var DomainContext = (0, import_react.createContext)(null);
function DomainProvider({
  ...
  const keyRef = (0, import_react.useRef)(storeKey);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DomainContext.Provider, { value: contextValue, children });
}
function useDomain() {
  const ctx = (0, import_react.useContext)(DomainContext);
  if (!ctx) {
...
function withDomain(Component) {
  return function WithDomainWrapper(props) {
    const store = useDomain();
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { ...props, store });
  };
}
