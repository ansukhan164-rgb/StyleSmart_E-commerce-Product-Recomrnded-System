...
var cloud_file_transport_exports = {};
__export(cloud_file_transport_exports, {
  CloudFileTransport: () => CloudFileTransport
});
module.exports = __toCommonJS(cloud_file_transport_exports);
...
//# sourceMappingURL=cloud-file-transport.cjs.map