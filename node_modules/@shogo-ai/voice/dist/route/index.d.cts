import { VoiceHandlersConfig, VoiceHandlers } from '../server.cjs';
import 'node:http';
import '../types-W9y6eMj3.cjs';
 ...
 */
declare function defaultHandlers(): VoiceHandlers;
/**
 ...
 * ```
 */
declare function createVoiceRoute(config: VoiceHandlersConfig): VoiceRoute;

export { type VoiceRoute, createVoiceRoute, defaultHandlers };
