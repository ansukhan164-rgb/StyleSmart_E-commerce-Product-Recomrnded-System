...
var tts_preview_exports = {};
__export(tts_preview_exports, {
  POST: () => POST
});
module.exports = __toCommonJS(tts_preview_exports);
...
// src/route/tts-preview.ts
var POST = (req) => defaultHandlers().tts(req);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  POST
});
//# sourceMappingURL=tts-preview.cjs.map