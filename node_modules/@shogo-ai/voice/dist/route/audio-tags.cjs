...
var audio_tags_exports = {};
__export(audio_tags_exports, {
  GET: () => GET
});
module.exports = __toCommonJS(audio_tags_exports);
...
// src/route/audio-tags.ts
var GET = (req) => defaultHandlers().audioTags(req);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  GET
});
//# sourceMappingURL=audio-tags.cjs.map