...
var import_react_native = require("@elevenlabs/react-native");
var import_jsx_runtime = require("react/jsx-runtime");
function ShogoVoiceProvider(props) {
  const { agentId, children } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react_native.ConversationProvider, { agentId, children });
}

// src/native/useVoiceConversation.ts
var import_react = require("react");
var import_react_native2 = require("react-native");
var import_react_native3 = require("@elevenlabs/react-native");
...
function useVoiceConversation(options) {
  ...
  const conversation = (0, import_react_native3.useConversation)({
  ...
  (0, import_react.useEffect)(() => {
    const sub = import_react_native2.AppState.addEventListener(
      "change",
      (nextState) => {
...
function useChatConversation(options = {}) {
  ...
  const resolvedApi = (0, import_react2.useMemo)(
  ...
  const toolsRef = (0, import_react2.useRef)(clientTools);
  ...
  const chat = (0, import_react3.useChat)({
    id: resolvedId,
    transport,
  ...
  const setMessages = (0, import_react2.useCallback)((messages) => {
    chatRef.current?.setMessages?.(messages);
  }, []);
  const appendAssistantMessage = (0, import_react2.useCallback)((text) => {
    const next = {
  ...
  const appendUserMessage = (0, import_react2.useCallback)((text) => {
    const next = {
...
var import_expo_three = require("expo-three");
...
function OrganicSphere({
  ...
  const resolvedConfig = (0, import_react4.useMemo)(
    () => resolveOrganicSphereConfig(configProp),
    [configProp]
  );
  const configRef = (0, import_react4.useRef)(resolvedConfig);
  (0, import_react4.useEffect)(() => {
    configRef.current = resolvedConfig;
  }, [resolvedConfig]);
  const getFrequencyDataRef = (0, import_react4.useRef)(getFrequencyData);
  const activeRef = (0, import_react4.useRef)(active);
  (0, import_react4.useEffect)(() => {
  ...
  const disposeRef = (0, import_react4.useRef)(null);
  (0, import_react4.useEffect)(() => {
    return () => {
      disposeRef.current?.();
  ...
  const onContextCreate = (0, import_react4.useMemo)(
    () => async (gl) => {
      const cfg0 = configRef.current;
      const width = gl.drawingBufferWidth;
      const height = gl.drawingBufferHeight;
      const pixelRatio = Math.min(initMaxPixelRatio ?? import_react_native4.PixelRatio.get(), 2);
      ...
      scene.add(camera);
      const renderer = new import_expo_three.Renderer({
        gl,
        antialias: true,
...
var import_expo_gl2 = require("expo-gl");
var import_expo_three2 = require("expo-three");
...
function OrganicParticles({
  ...
  const resolvedConfig = (0, import_react5.useMemo)(
    () => resolveOrganicParticlesConfig(configProp),
    [configProp]
  );
  const configRef = (0, import_react5.useRef)(resolvedConfig);
  (0, import_react5.useEffect)(() => {
    configRef.current = resolvedConfig;
  }, [resolvedConfig]);
  const getFrequencyDataRef = (0, import_react5.useRef)(getFrequencyData);
  const activeRef = (0, import_react5.useRef)(active);
  (0, import_react5.useEffect)(() => {
    getFrequencyDataRef.current = getFrequencyData;
  }, [getFrequencyData]);
  (0, import_react5.useEffect)(() => {
  ...
  const disposeRef = (0, import_react5.useRef)(null);
  (0, import_react5.useEffect)(() => {
    return () => {
      disposeRef.current?.();
      disposeRef.current = null;
  ...
  const initMaxPixelRatio = resolvedConfig.maxPixelRatio;
  const initBackgroundColor = resolvedConfig.backgroundColor;
  const onContextCreate = (0, import_react5.useMemo)(
    () => async (gl) => {
      const cfg0 = configRef.current;
      const width = gl.drawingBufferWidth;
      const height = gl.drawingBufferHeight;
      const pixelRatio = Math.min(initMaxPixelRatio ?? import_react_native5.PixelRatio.get(), 2);
      ...
      camera.position.set(0, 0, cfg0.cameraZ);
      scene.add(camera);
      const renderer = new import_expo_three2.Renderer({
        gl,
        antialias: true,
        alpha: initBackgroundColor === null,
        powerPreference: "high-performance"
